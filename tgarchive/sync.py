...
class Sync:
    ...
    def list_groups(self):
        """
        List all available groups/channels for the user.
        """
        dialogs = self.client.get_dialogs()
        print("Available groups/channels:")
        for dialog in dialogs:
            if dialog.is_group or dialog.is_channel:
                print(f"ID: {dialog.id}, Name: {dialog.name}, Username: @{dialog.entity.username if dialog.entity.username else 'None'}")
